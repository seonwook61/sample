            				  ...
            				  alert(window.URL.createObjectURL(image.files[0]) + " : " + $("#upfile").val() );
            				   ...
            				   var orifilearr = orifile.split(".");  
            		             ...
            		             if(ext.toLowerCase() == "jpg" || ext.toLowerCase() == "png" || ext.toLowerCase() == "gif") {
            		                  filepopup.dispreview = "<img src='" + imgpath + "''>";
            		               } else {
					...
					<div class="content">
						...
						<p class="Location">
							<a href="../dashboard/dashboard.do" class="btn_set home">메인으로</a> <span
								class="btn_nav bold">학습관리</span> <span class="btn_nav bold">View게시판</span> <a href="../system/comnCodMgr.do" class="btn_set refresh">새로고침</a>
						</p>
